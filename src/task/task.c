...
void task_current_save_state(struct interrupt_frame* frame)
{
    if (!task_current())
    {
        panic("\ntask_current_save_state: No current task to save\n");
    }
...
void task_run_first_ever_task()
{
    if(!current_task)
    {
        panic("\ntask_run_first_ever_task: No tasks to run!!!\n");
    }
...
void* task_virtual_address_to_physical(struct task* task, void* virtual_addr)
{
    return paging_get_physical_address(task->page_directory->directory_entry, virtual_addr);
}
