...
{
    void* virt_new_addr = paging_align_to_lower_page(virt);
    void* difference = (void*) (uint32_t) virt - (uint32_t) virt_new_addr;
    return (void*) ((paging_get(directory, virt_new_addr) & 0xfffff000) + difference);
}
